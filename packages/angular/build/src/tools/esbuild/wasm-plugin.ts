    ...
    setup(build): void {
      ...
      build.onLoad(
        ...
        createCachedLoad(cache, async (args) => {
          ...
          initContents += generateInitHelper(!inlineWasm, wasmContents);
 ...
 * also generated and used with the fetch action. A separate helper function is
 * generated to allow for non-async usage features in the future by exporting
 * this helper as the default export instead of the integration proposal behavior.
 *
